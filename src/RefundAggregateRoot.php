...
use PaymentSystem\Stripe\Events\Refund\Created;
use Stripe\Refund;
...
class RefundAggregateRoot implements AggregateRoot
{
    ...
    {
        $this->recordThat(new Created($refund));

        return $this;
    }

    protected function applyRefundCreated(Refund $refund): void
    {
        $this->stripeRefund = $refund;
    }
}