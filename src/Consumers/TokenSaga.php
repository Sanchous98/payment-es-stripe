...
use PaymentSystem\Stripe\Repositories\TokenRepositoryInterface;
...
{
    /**
     * @param TokenRepositoryInterface $stripeTokenRepository
     * @param AggregateRootRepository<TokenAggregateRoot> $tokenRepository
     * @param DecryptInterface $decrypt
     */
    public function __construct(
        private TokenRepositoryInterface $stripeTokenRepository,
